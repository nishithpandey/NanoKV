 ...
 */
@Command
public class NanoKVClientCliRunner implements Runnable {
    ...
    private NanoKVClientConfig initConfig() {
        NanoKVClientConfig.NanoKVClientConfigBuilder configBuilder = new NanoKVClientConfig.NanoKVClientConfigBuilder();
        ...
        NanoKVClientConfig config = configBuilder.build();
        if (printConfig) {
    ...
    private NanoKVClient initClient() {
        NanoKVClientConfig config = initConfig();
        return NanoKVClient.newInstance(config);
    }
    ...
    private <T> T call(Function<KV, T> func) {
        try (NanoKVClient client = initClient()) {
    ...
    public static void main(String[] args) {
        CommandLine.run(new NanoKVClientCliRunner(), args);
    }
}
