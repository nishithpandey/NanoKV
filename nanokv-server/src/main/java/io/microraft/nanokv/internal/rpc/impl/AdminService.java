...
import io.microraft.nanokv.admin.proto.AddRaftEndpointAddressResponse;
import io.microraft.nanokv.admin.proto.AddRaftEndpointRequest;
import io.microraft.nanokv.admin.proto.AddRaftEndpointResponse;
...
import io.microraft.nanokv.admin.proto.TakeSnapshotRequest;
import io.microraft.nanokv.admin.proto.TakeSnapshotResponse;
...
import static io.microraft.nanokv.internal.utils.Serialization.toProto;
...
public class AdminService extends AdminServiceImplBase {
    ...
    public void removeRaftEndpoint(RemoveRaftEndpointRequest request,
        ...
        NanoKVEndpoint endpoint = NanoKVEndpoint.wrap(request.getEndpoint());
    ...
    public void addRaftEndpointAddress(AddRaftEndpointAddressRequest request,
        ...
        try {
            RaftEndpoint endpoint = NanoKVEndpoint.wrap(request.getEndpoint());
