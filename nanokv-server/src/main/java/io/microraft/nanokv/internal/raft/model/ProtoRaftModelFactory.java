...
import io.microraft.nanokv.internal.raft.model.groupop.UpdateRaftGroupMembersOpOrBuilder;
import io.microraft.nanokv.internal.raft.model.log.LogEntryOrBuilder;
import io.microraft.nanokv.internal.raft.model.log.SnapshotChunkOrBuilder;
import io.microraft.nanokv.internal.raft.model.log.SnapshotEntryOrBuilder;
import io.microraft.nanokv.internal.raft.model.log.RaftGroupMembersViewOrBuilder;
...
import io.microraft.nanokv.internal.raft.model.persistence.RaftEndpointPersistentStateOrBuilder;
import io.microraft.nanokv.internal.raft.model.persistence.RaftTermPersistentStateOrBuilder;
...
public class ProtoRaftModelFactory implements RaftModelFactory {
    ...
    public RaftEndpointPersistentStateBuilder createRaftEndpointPersistentStateBuilder() {
        return new RaftEndpointPersistentStateOrBuilder();
    }

    @Override
    public RaftTermPersistentStateBuilder createRaftTermPersistentStateBuilder() {
        return new RaftTermPersistentStateOrBuilder();
    }
