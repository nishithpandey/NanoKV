...
import io.microraft.nanokv.raft.proto.InstallSnapshotRequestProto;
...
public class InstallSnapshotRequestOrBuilder
    ...
    public InstallSnapshotRequestOrBuilder(InstallSnapshotRequestProto request) {
        ...
        this.sender = NanoKVEndpoint.wrap(request.getSender());
        ...
        this.snapshottedMembers = request.getSnapshottedMemberList().stream().map(NanoKVEndpoint::wrap)
                .collect(toList());
    ...
    public InstallSnapshotRequestBuilder setSender(@Nonnull RaftEndpoint sender) {
        builder.setSender(NanoKVEndpoint.unwrap(sender));
        this.sender = sender;
        return this;
    }
    ...
    public InstallSnapshotRequestBuilder setSnapshottedMembers(@Nonnull Collection<RaftEndpoint> snapshottedMembers) {
        snapshottedMembers.stream().map(NanoKVEndpoint::unwrap).forEach(builder::addSnapshottedMember);
