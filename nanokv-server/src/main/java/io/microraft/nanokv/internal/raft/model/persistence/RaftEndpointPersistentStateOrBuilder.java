package io.microraft.nanokv.internal.raft.model.persistence;

import io.microraft.RaftEndpoint;
import io.microraft.model.persistence.RaftEndpointPersistentState;
import io.microraft.nanokv.raft.proto.RaftEndpointPersistentStateProto;
import io.microraft.nanokv.raft.proto.RaftRequest.Builder;
...
public class RaftEndpointPersistentStateOrBuilder
    ...
    public RaftEndpointPersistentStateBuilder setLocalEndpoint(RaftEndpoint localEndpoint) {
        builder.setLocalEndpoint(NanoKVEndpoint.unwrap(localEndpoint));
