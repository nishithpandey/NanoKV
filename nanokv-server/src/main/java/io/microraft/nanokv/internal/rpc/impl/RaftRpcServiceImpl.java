...
import static io.microraft.nanokv.internal.di.NanoKVModule.RAFT_ENDPOINT_ADDRESSES_KEY;
import static io.microraft.nanokv.internal.utils.Exceptions.runSilently;
import static io.microraft.nanokv.internal.utils.Serialization.wrap;
import static io.microraft.nanokv.internal.utils.Threads.nextThreadId;
...
import io.microraft.nanokv.raft.proto.RaftResponse;
import io.microraft.nanokv.raft.proto.RaftServiceGrpc;
import io.microraft.nanokv.raft.proto.RaftServiceGrpc.RaftServiceStub;
...
public class RaftRpcServiceImpl implements RaftRpcService {
    ...
    public RaftRpcServiceImpl(@Named(LOCAL_ENDPOINT_KEY) RaftEndpoint localEndpoint,
            @Named(CONFIG_KEY) NanoKVConfig config,
