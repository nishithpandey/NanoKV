...
package io.microraft.nanokv.internal.utils;

import io.microraft.nanokv.admin.proto.RaftGroupMembersProto;
import io.microraft.nanokv.admin.proto.RaftLogStatsProto;
import io.microraft.nanokv.admin.proto.RaftNodeReportProto;
import io.microraft.nanokv.admin.proto.RaftNodeReportReasonProto;
import io.microraft.nanokv.admin.proto.RaftNodeStatusProto;
import io.microraft.nanokv.admin.proto.RaftRoleProto;
import io.microraft.nanokv.admin.proto.RaftTermProto;
import io.microraft.nanokv.internal.raft.model.NanoKVEndpoint;
import io.microraft.nanokv.internal.raft.model.message.AppendEntriesFailureResponseOrBuilder;
import io.microraft.nanokv.internal.raft.model.message.AppendEntriesRequestOrBuilder;
import io.microraft.nanokv.internal.raft.model.message.AppendEntriesSuccessResponseOrBuilder;
import io.microraft.nanokv.internal.raft.model.message.InstallSnapshotRequestOrBuilder;
import io.microraft.nanokv.internal.raft.model.message.InstallSnapshotResponseOrBuilder;
import io.microraft.nanokv.internal.raft.model.message.PreVoteRequestOrBuilder;
import io.microraft.nanokv.internal.raft.model.message.PreVoteResponseOrBuilder;
import io.microraft.nanokv.internal.raft.model.message.RaftRequestAware;
import io.microraft.nanokv.internal.raft.model.message.TriggerLeaderElectionRequestOrBuilder;
import io.microraft.nanokv.internal.raft.model.message.VoteRequestOrBuilder;
import io.microraft.nanokv.internal.raft.model.message.VoteResponseOrBuilder;
...
public final class Serialization {
    ...
    public static RaftNodeReportProto toProto(RaftNodeReport report) {
        return RaftNodeReportProto.newBuilder().setReason(toProto(report.getReason()))
                .setGroupId((String) report.getGroupId()).setEndpoint(NanoKVEndpoint.unwrap(report.getEndpoint()))
    ...
    public static RaftGroupMembersProto toProto(RaftGroupMembers groupMembers) {
        ...
        groupMembers.getMembers().stream().map(NanoKVEndpoint::unwrap).forEach(builder::addMember);
    ...
    public static RaftTermProto toProto(RaftTerm term) {
        ...
        if (term.getLeaderEndpoint() != null) {
            builder.setLeaderEndpoint(NanoKVEndpoint.unwrap(term.getLeaderEndpoint()));
        }

        if (term.getVotedEndpoint() != null) {
            builder.setVotedEndpoint(NanoKVEndpoint.unwrap(term.getVotedEndpoint()));
        }
