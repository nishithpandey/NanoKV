...
public class NanoKVBenchmarkRunner {
    ...
    public void runBenchmark(String[] args) throws RunnerException, CmdLineException {
        ...
        ChainedOptionsBuilder optionsBuilder = new OptionsBuilder().include(NanoKVBenchmark.class.getSimpleName());
    ...
    public static void main(String[] args) throws RunnerException, CmdLineException {
        new NanoKVBenchmarkRunner().runBenchmark(args);
    }
