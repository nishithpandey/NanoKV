...
package io.microraft.nanokv.client.internal.di;
...
import io.microraft.nanokv.client.internal.channel.impl.ChannelManagerImpl;
import io.microraft.nanokv.client.internal.kv.impl.KVSupplier;
import io.microraft.nanokv.client.internal.rpc.InvocationService;
import io.microraft.nanokv.client.internal.rpc.impl.MultiKVServiceStubManager;
import io.microraft.nanokv.client.internal.rpc.impl.UniKVServiceStubManager;
...
public class NanoKVClientModule extends AbstractModule {
    ...
    public NanoKVClientModule(NanoKVClientConfig config, AtomicBoolean processTerminationFlag) {
        this.config = config;
    ...
    protected void configure() {
        ...
        bind(NanoKVClientConfig.class).annotatedWith(named(CONFIG_KEY)).toInstance(config);
